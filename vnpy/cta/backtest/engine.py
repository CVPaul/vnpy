...
import vnpy.cta.strategy
from vnpy.cta.strategy import CtaTemplate, TargetPosTemplate
from vnpy.cta.strategy.backtesting import (
    BacktestingEngine,
    OptimizationSetting,
    BacktestingMode
)
...
class BacktesterEngine(BaseEngine):
    ...
    def load_strategy_class(self) -> None:
        ...
        """
        app_path: Path = Path(vnpy.cta.strategy.__file__).parent
